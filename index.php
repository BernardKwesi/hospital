...
<img src= "assets/images/logo.jpg" style="width:200px;height:120px; border-radius:50%; alt="">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                      ...
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">KTU Hospital Management System</h5>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/pt.jpg" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/ed.jpg" alt="">
 ...
 <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src= "assets/images/nurse_1.jpg" alt="">

                            <div class="blog-single-det">
                                <h6>Nurse login</h6>
                                <a href="hms/nurse/index.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
...
<br><br><br><br><br><br><br><br><br><br><br><br>
 <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/Pharmacist_2.jpg" alt="">

                            <div class="blog-single-det">
                                <h6>Pharmacy login</h6>
                                <a href="Pharmacy-Management/index.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
