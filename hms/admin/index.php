...
<h2><img src= "assets/images/logo.jpg" style="width:100px;height:100px; border-radius:50%; alt=""><STRONG>
Admin Login</STRONG></h2>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						<span class="text-bold text-uppercase">KOFRIDUA TECHNICAL UNIVERSITY Hospital Management System</span>
					</div>
