...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Patient Vitals | Add Vitals</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Patient</span>
...
<h5 class="panel-title">Add Vitals</h5>
</div>
...
<textarea name="pataddress" class="form-control"  placeholder="Enter Patient Temp" required="true"></textarea>
</div>
<div class="form-group">
<label for="fess">
 BP/mmhg
</label>
<input type="text" name="patage" class="form-control"  placeholder="Enter Bp/mmHG" required="true">
</div>
<div class="form-group">
<label for="fess">
 Comments
